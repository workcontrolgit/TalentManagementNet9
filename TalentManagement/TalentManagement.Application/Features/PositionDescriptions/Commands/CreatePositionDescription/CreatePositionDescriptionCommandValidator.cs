...
{
    public class CreatePositionDescriptionCommandValidator : AbstractValidator<CreatePositionDescriptionCommand>
    {
        public CreatePositionDescriptionCommandValidator()
        {
            RuleFor(p => p.PdNbr)
